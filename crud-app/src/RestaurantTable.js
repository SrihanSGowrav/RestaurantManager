...
const RestaurantTable = () => {
    ...
    const fetchRestaurants = async () => {
        try {
            const response = await axios.get ("http://localhost:8003/getAllMenus");
    ...
    return(
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <br /><br />
                Type : <input name='type'value={ form. type} onChange={handleChange} />
                <br /><br />
                Rating : <input name='rating'value={ form. rating} onChange={handleChange} />
                <br /><br />
                Top_Food : <input name='top_food'value={ form. top_food} onChange={handleChange} />
                <br /><br />
